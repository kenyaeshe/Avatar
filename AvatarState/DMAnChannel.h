...
// Structure for conveniently and compactly read/writing to DMA control registers. See reference manual for more info.
typedef struct __attribute__((packed, aligned(4))) TCD_t {
...
extern TCD_t enc_receive_tcd, link_send_tcd, link_receive_tcd, enc_trig_tcd, state_tcd, stamp_tcd;
