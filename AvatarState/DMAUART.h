...
// structure allows compact reference and assignment of UART control registers. See reference manual for more info.
...
extern LPUART_t enc_uart, link_uart, state_uart;
